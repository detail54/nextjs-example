// 아이디 찾기 폼 스타일 상수
export const findUsernameFormStyles = {
  ...
  divider: 'text-secondary-300 text-xs select-none px-0.5',

  // ── 결과 뷰 ──
  resultBox: 'rounded-xl border border-secondary-200 bg-secondary-50 p-6 space-y-3',
  resultDesc: 'text-sm text-secondary-500',
  resultUsername: 'text-xl font-bold text-secondary-900 tracking-wide',
  resultActions: 'pt-4 space-y-3',
}
